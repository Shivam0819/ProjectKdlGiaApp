                                  ...
                                  child: Container(
                                    child: Row(
                                      children: [
                                        InkWell(
                                          onTap: () {
                                            if (orderData.diaReport == "GIA" ||
                                                orderData.diaReport == "IGI") {
                                ...
                                children: [
                                  TableRow(children: [
                                    TableCell(
                                        child: StyledText(
                                            text:
                                                "Shp: ${orderData.diaShape}")),
                                    TableCell(
                                        child: StyledText(
                                            text:
                                                "Carat: ${orderData.diaCarat}")),
                                    TableCell(
                                        child: StyledText(
                                            text:
                                                "Color: ${orderData.diaColor}")),
                                    TableCell(
                                        child: StyledText(
                                            text:
                                                "Clarity: ${orderData.diaClarity}")),
                                  ]),
                                  TableRow(children: [
                                    TableCell(
                                        child: StyledText(
                                    ...
                                    TableCell(
                                        child: StyledText(
                                            text:
                                                "Polish: ${orderData.diaPolish}")),
                                    TableCell(
                                        child: StyledText(
                                            text:
                                                "Symm: ${orderData.diaSymmetry}")),
                                    TableCell(
                                        child: StyledText(
                                            text:
                                  ...
                                  TableRow(children: [
                                    TableCell(
                                        child: StyledText(
                                            text:
                                                "Loc: ${orderData.diaPlace}")),
                                    TableCell(
                                        child: StyledText(
                                            text:
                                                "Tbl : ${orderData.diaTable}")),
                                    TableCell(
                                        child: StyledText(
